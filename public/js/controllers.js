...
webAppControllers.controller('AboutCtrl', ['$scope', '$http','$window','$location',
    function ($scope, $http, $window, $location) {
        //console.log("In the About Controller");
    }
]);

webAppControllers.controller('SuccessCtrl', ['$scope', '$http','$window','$location',
    function ($scope, $http, $window, $location) {
        //console.log("In the Success Controller");
    }
]);

/*webAppControllers.controller('ViewProfileCtrl', ['$scope', '$http','$window','$location',
    function ($scope, $http, $window, $location) {
        console.log("In the ViewProfile Controller");
    }
]);*/

webAppControllers.controller("ViewProfileCtrl",function($scope,$window,$location,$routeParams){
	$scope.userId=$routeParams.userId;
	//console.log("In the ViewProfile Controller="+$scope.userId);
});

webAppControllers.controller('DashboardCtrl', ['$scope', '$http','$window','$location',
    function ($scope, $http, $window, $location) {
        //console.log("In the Dashboard Controller");
		$scope.customNavigate=function(msg){
			//console.log("arg="+msg);
			$location.path("/home/#/viewprofile"+msg);
		}
    }
]);

webAppControllers.controller('EvaluateCtrl', ['$scope', '$http','$window','$location',
    function ($scope, $http, $window, $location) {
        //console.log("In the Evaluate Controller");
    }
]);

webAppControllers.controller('FailureCtrl', ['$scope', '$http','$window','$location',
    function ($scope, $http, $window, $location) {
        //console.log("In the Failure Controller");
    }
]);

webAppControllers.controller('ManageEvalCtrl', ['$scope', '$http','$window','$location',
    function ($scope, $http, $window, $location) {
        //console.log("In the ManageEval Controller");
    }
]);

webAppControllers.controller('ManageRateCtrl', ['$scope', '$http','$window','$location',
    function ($scope, $http, $window, $location) {
        //console.log("In the ManageRate Controller");
    }
]);

webAppControllers.controller('ManageSkillCtrl', ['$scope', '$http','$window','$location',
    function ($scope, $http, $window, $location) {
        //console.log("In the ManageSkill Controller");
    }
]);

webAppControllers.controller('ManageCertCtrl', ['$scope', '$http','$window','$location',
    function ($scope, $http, $window, $location) {
        //console.log("In the ManageCert Controller");
    }
]);

webAppControllers.controller('SelfEvalCtrl', ['$scope', '$http','$window','$location',
    function ($scope, $http, $window, $location) {
        //console.log("In the SelfEval Controller");
    }
]);
